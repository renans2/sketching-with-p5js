...
function drawHoursIcons() {
  ...
  for (let i = 0; i < 12; i++) {
    stroke(255);
    circle(
      cos(i * offsetBigIcons) * iconDistance,
      sin(i * offsetBigIcons) * iconDistance,
      hourIconDiameter,
    );
  }
}
...
function drawHoursSmallIcons() {
  ...
  for (let i = 0; i < 60; i++) {
    stroke(255);
    circle(
      cos(i * offsetSmallIcons) * iconDistance,
      sin(i * offsetSmallIcons) * iconDistance,
      smallIconsDiameter,
    );
  }
}
...
function drawPointers() {
  ...
  line(
    0,
    0,
    cos(angleSeconds) * secPointerMult,
  ...
  line(
    0,
    0,
    cos(angleMinutes) * minPointerMult,
  ...
  line(
    0,
    0,
    cos(angleHours) * hourPointerMult,
